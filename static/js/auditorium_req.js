...
$(document).ready(function () {
    ...
    $('#my_data tbody').on('click', 'tr', function () {
        ...
        // document.querySelector("#payment_img").src = None;
        // document.querySelector("#link_image").href=None;
        ...
        payment_image_request.open("GET", "http://127.0.0.1:5000/audi_payment_image?query=" + d[1], true);
    ...
    $('#confirm').click(function () {
        ...
        xhttp.open("POST", "http://127.0.0.1:5000/auditorium_confirmation?query=Yes&req_id=" + req_id + "&name="
    ...
    $('#discard').click(function () {
        ...
        //send.user_name=user;
        xhttp.open("POST", "http://127.0.0.1:5000/auditorium_confirmation?query=No&req_id=" + req_id + "&name="
            + user + "&email=" + email + "&room_name=" + room_name
            + "&start_date=" + start_date, true);
        xhttp.send();
